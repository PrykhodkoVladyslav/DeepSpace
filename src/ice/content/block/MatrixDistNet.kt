...
object MatrixDistNet {
  ...
  var 矩阵桥 = MatrixBridge("matrix_bridge").apply {
    requirements(
      SglCategory.matrix, IItems.矩阵合金, 20, IItems.强化合金, 18, IItems.FEX水晶, 10, IItems.气凝胶, 16, IItems.絮凝剂, 8
    )
    squareSprite = false
    size = 2
    newConsume()
  ...
  var 矩阵塔 = MatrixBridge("matrix_tower").apply {
    requirements(
      SglCategory.matrix, IItems.矩阵合金, 40, IItems.强化合金, 24, IItems.充能FEX水晶, 18, IItems.铱锭, 6, IItems.絮凝剂, 12
  ...
  var 网格框架 = MatrixEdgeBlock("matrix_grid_node").apply {
    ...
    requirements(
      SglCategory.matrix, ItemStack.with(
        IItems.矩阵合金, 40, IItems.强化合金, 25, IItems.铱锭, 12, IItems.絮凝剂, 20
      )
    )
    linkOffset = 4.5f
    size = 2
  ...
  var 能源簇 = DistEnergyBuffer("matrix_energy_buffer").apply {
    ...
    requirements(
      SglCategory.matrix, ItemStack.with(
        IItems.矩阵合金, 70, IItems.FEX水晶, 45, IItems.充能FEX水晶, 35, IItems.铱锭, 20, IItems.絮凝剂, 40
      )
    )
    size = 3
    localization {
  ...
  var 能量接口 = DistPowerEntry("matrix_power_interface").apply {
    ...
    requirements(
      SglCategory.matrix, ItemStack.with(
        IItems.矩阵合金, 45, IItems.铜锭, 40, IItems.单晶硅, 35, IItems.钴锭, 30, IItems.铬锭, 30
      )
    )
    size = 2
    localization {
  ...
  var 矩阵处理单元 = CoreNeighbourComponent("matrix_process_unit").apply {
    ...
    requirements(
      SglCategory.matrix, ItemStack.with(
        IItems.矩阵合金, 45, IItems.FEX水晶, 45, IItems.强化合金, 50, IItems.铱锭, 35, IItems.絮凝剂, 40
      )
    )
    size = 3
    squareSprite = false
  ...
  var 矩阵拓扑容器 = CoreNeighbourComponent("matrix_topology_container").apply {
    ...
    requirements(
      SglCategory.matrix, ItemStack.with(
        IItems.矩阵合金, 80, IItems.FEX水晶, 50, IItems.强化合金, 80, IItems.铱锭, 45, IItems.絮凝剂, 80, IItems.铬锭, 75
      )
    )
    size = 4
    squareSprite = false
  ...
  var 通用物质缓存器 = NetPluginComp("matrix_buffer").apply {
    ...
    requirements(
      SglCategory.matrix, ItemStack.with(
        IItems.矩阵合金, 60, IItems.FEX水晶, 45, IItems.气凝胶, 40, IItems.铱锭, 28, IItems.絮凝剂, 45
      )
    )
    size = 3
