...
import singularity.world.blocks.defence.ShieldWall
...
object DefenseBlocks {
  ...
  val 流金墙 = Wall("fluxGoldWall").apply {
    size = 1
    armor = 5f
    health = 360
    healAmount = 10f
  ...
  val 大型陶钢墙 = Wall("potterySteelWallLarge").apply {
    health = 陶钢墙.health * 4
    armor = 12f
    size = 2
    floating = true
  ...
  val 大型铱墙 = Wall("iridiumWallLarge").apply {
    size = 2
    armor = 20f
    health = 铱墙.health * 4
    crushDamageMultiplier = 2.5f
  ...
  val 大型强化合金墙 = Wall("strengthening_alloy_wall_large").apply {
    ...
    requirements(Category.defense, IItems.强化合金, 32)
  }
  val 生物钢墙 = Wall("biologicalSteelWall").apply {
    health = 1500
    armor = 8f
    insulated = true
    absorbLasers = true
  ...
  val 大型生物钢墙 = Wall("biologicalSteelWallLarge").apply {
    health = 生物钢墙.health * 4
    armor = 32f
    size = 2
    healAmount = 生物钢墙.healAmount * 4
    damageReduction = 生物钢墙.crushDamageMultiplier
    insulated = true
    absorbLasers = true
    placeableLiquid = true
    crushDamageMultiplier = 0.5f
  ...
  val 相控雷达 = PhasedRadar("phased_radar").apply {
    ...
    requirements(Category.defense, IItems.黄铜锭, 10, IItems.铬锭, 20, IItems.单晶硅, 5)
  }
  ...
  val 简并态中子聚合物墙 = SglWall("neutron_polymer_wall").apply {
    ...
    damageFilter = 72f
    absorbLasers = true
    requirements(Category.defense, IItems.简并态中子聚合物, 8, IItems.强化合金, 4)
  }
  val 大型简并态中子墙 = SglWall("neutron_polymer_wall_large").apply {
    ...
    absorbLasers = true
    squareSprite = false
    requirements(Category.defense, IItems.简并态中子聚合物, 32, IItems.强化合金, 16, IItems.气凝胶, 8)
  }
